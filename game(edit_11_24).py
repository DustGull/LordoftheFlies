...
def main():
    ...
    while playing:
        ...
        # Respond differently depending on glasses status
            ...
            elif "glasses" in inventory:
                dialog = "I can see again!"
            if "rock" in inventory: # jack_has_glasses

...
def load_tiles_and_make_dict_and_rect():
    # Load the tiles
    sand = pygame.image.load("Sand.png").convert_alpha() # (206, 206, 46, 255)
    tile_rect = sand.get_rect()
    plains = pygame.image.load("Plains.png").convert_alpha() # (126, 206, 46, 255)
    swamp = pygame.image.load("Jungle.png").convert_alpha() # (14,64,14,255)
    dirt = pygame.image.load("Dirt.png").convert_alpha() # (117,94,21,255)
    water = pygame.image.load("Water.png").convert_alpha() # (0, 176, 255, 255)
    rocks = pygame.image.load("Rocky.png").convert_alpha() # (39, 39, 21, 255)
...
def main():
    ...
    # load mini map
    world = pygame.image.load("New Piskel.png").convert()

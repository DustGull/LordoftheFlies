...
#Tiles needed:
#Sand, water and something else~ grass?

#def load_tiles_and_make_dict_and_rect():
    #sand = pygame.image.load("#").convert_alpha() #find its unique numbers
    #tile_rect = sand.get_rect()
    #water = pygame.image.load("#").convert_alpha()
    #grass = pygame.image.load("#").convert_alpha()
    #Repeat to add tiles

#making a dictionary to add tiles

#tiles = {}
#tiles[("# Add its unique numbers")] = sand
#tiles[("#its number")] = water
#tiles[("its number")] = grass
#Add tiles if needed
...
def main():
    ...
    map = pygame.image.load("New Piskel.png").convert()
